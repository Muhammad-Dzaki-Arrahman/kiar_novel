...
@section('container')
<div class="mr-6">
    <h1 class="text-4xl font-semibold mb-2">Add New Category</h1>
</div>
...
<form class="w-full max-w-screen mb-64" action="/dashboard/category" method="post">
    @csrf
    <div class="flex flex-wrap -mx-3 mb-6">
      <div class="w-full md:w-full px-3 mb-6 md:mb-0">
        ...
        @enderror
        <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white @error('name') is-invalid @else is-valid @enderror" id="title" type="text" name="name" placeholder="Ex. Supernatural" value="{{ old('name') }}" autofocus>
      </div>
    </div>
    <div class="flex flex-wrap -mx-3 mb-6">
    ...
    <button class="bg-emerald-400 rounded border hover:bg-emerald-600 font-bold p-3">Add Category</button>
  </form>
