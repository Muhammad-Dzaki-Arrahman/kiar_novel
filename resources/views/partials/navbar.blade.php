  ...
  <header class="header sticky top-0 position-static bg-white shadow-md flex items-center justify-between px-8 py-02 w-full">
    <!-- logo -->
    <h1 class="w-3/12 flex -mt-1">
      <div class="flex w-14">
        <img src="../image/ml.png" alt="Kiar Blog Logo" width="50">
      </div>
      <div class="flex w-41">
        <p class="mt-2 font-semibold text-emerald-700">Kiar Blog</p>
      </div>
    </h1>

    <!-- navigation -->
  
    <nav class="navbar font-semibold text-lg navbar-expand-xl"> 

        <ul class="flex items-center text-emerald-700">
            ...
            <li class="p-4 border-b-2 border-green-500 border-opacity-0 hover:border-opacity-100 hover:text-green-500 duration-200 cursor-pointer {{ Request::is('about') ? 'text-green-500' : ''}}">
    ...
    <div x-data="{ isOpen: false }" class="relative inline-block ">
      ...
      <button @click="isOpen = !isOpen" class="relative z-10 flex items-center p-2 text-sm text-zinc-50 bg-teal-800 border border-transparent rounded-md focus:border-blue-500 focus:ring-opacity-40  focus:ring-blue-300 focus:outline-none">
          <span class="mx-1">Welcome, {{ auth()->user()->name }}</span>
      ...
      <div x-show="isOpen" 
          ...
          class="absolute right-0 z-20 w-56 py-2 mt-2 overflow-hidden origin-top-right bg-teal-800 rounded-md shadow-xl">
          <a href="#" class="flex items-center p-3 -mt-2 text-sm text-gray-600 transition-colors duration-300 transform dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-white dark:hover:text-zinc-950">
              ...
              <div class="mx-1">
                  <h1 class="text-sm font-semibold text-gray-700 dark:text-gray-200 dark:hover:bg-white dark:hover:text-zinc-950">{{ auth()->user()->name }}</h1>
                  <p class="text-sm text-gray-500 dark:text-gray-400 dark:hover:bg-white dark:hover:text-zinc-950">{{ auth()->user()->email }}</p>
              </div>
          </a>
  
          <hr class="border-gray-200 dark:border-gray-700 ">
  
          <a href="#" class="flex items-center p-3 text-sm text-gray-600 capitalize transition-colors duration-300 transform dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-white dark:hover:text-zinc-950">
              <svg class="w-5 h-5 mx-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <a href="/dashboard" class="flex items-center p-3 text-sm text-gray-600 capitalize transition-colors duration-300 transform dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-white dark:hover:text-zinc-950">
              <svg class="w-5 h-5 mx-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <form action="/logout" method="post">
            @csrf
            <button class="flex items-center p-3 text-sm text-gray-600 capitalize transition-colors duration-300 transform dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-white dark:hover:text-zinc-950 w-56">
            <svg class="w-5 h-5 mx-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          {{-- <a href="/login" class="flex items-center p-3 text-sm text-gray-600 capitalize transition-colors duration-300 transform dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-white dark:hover:text-zinc-950">
              <svg class="w-5 h-5 mx-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M19 21H10C8.89543 21 8 20.1046 8 19V15H10V19H19V5H10V9H8V5C8 3.89543 8.89543 3 10 3H19C20.1046 3 21 3.89543 21 5V19C21 20.1046 20.1046 21 19 21ZM12 16V13H3V11H12V8L17 12L12 16Z" fill="currentColor"></path>
              </svg>
